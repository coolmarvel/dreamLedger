...
export const BlockManagerPageServers = () => {
  ...
  const { form, returnValue, returnError, data } = useSelector(({ auth }) => ({
    form: auth.blockManagerServers,
    returnValue: auth.blockManager.servers.returnValue,
    returnError: auth.blockManager.servers.error,
    data: auth.blockManager.servers.data,
  }));
  ...
  const list = data.map((info, index) => (
    <tr>
      <td id={index} onClick={onClickList}>
        {info.name}
      </td>
      <td>
        <div className="state_default" id={index} onClick={onClickList}>
          {" "}
          default
        </div>
      </td>
                  ...
                  <div className="con_menu_tb_wrap">
                    <div className="table_wrap">
                      <table id="tableData" className="dt_tbl">
                        ...
                        <tbody>{list.length > 0 && list}</tbody>
                      </table>
                    </div>
                  </div>
                </div>
                          ...
                          <tr>
                            <td>
                              ...
                              <input
                                ...
                                value={
                                  data[serverIndex].hostIp == null
                                    ? "null"
                                    : data[serverIndex].hostIp
                                }
                              />
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <input
                                ...
                                placeholder="null"
                                value={
                                  data[serverIndex].sftpPort == null
                                    ? "null"
                                    : data[serverIndex].sftpPort
                                }
                              />
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <input
                                ...
                                placeholder="null"
                                value={
                                  data[serverIndex].dockerPort == null
                                    ? "null"
                                    : data[serverIndex].dockerPort
                                }
                              />
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <input
                                ...
                                placeholder="null"
                                value={
                                  data[serverIndex].uid == null
                                    ? "null"
                                    : data[serverIndex].uid
                                }
                              />
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <input
                                ...
                                placeholder="null"
                                value={
                                  data[serverIndex].gid == null
                                    ? "null"
                                    : data[serverIndex].gid
                                }
                              />
                            </td>
                          </tr>
