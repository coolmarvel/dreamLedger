...
import { getCAServer } from "../../../../../api/dashboardAPI";
...
function OrgsDialog({ setLoading }) {
  ...
  return (
    <div>
      <Typography onClick={handleClickOpen}>CA Servers</Typography>
      <BootstrapDialog
        onClose={handleClose}
            ...
            >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center">CA Server-Name</TableCell>
                </TableRow>
              </TableHead>
