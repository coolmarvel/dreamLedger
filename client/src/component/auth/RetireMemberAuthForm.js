...
const RetireMemberAuthForm = ({ userId,type, form, onChange, onSubmit,onCancel, error }) => {
      ...
      <form onSubmit={onSubmit} onclose={onCancel}>
            <div>
                  ...
                  <div className="join-cont">
                      ...
                      <p className="mydel-desc01">지금까지 이용해주셔서 감사 드립니다. 탈퇴하기 전 아래 유의사항을 확인해주세요.</p>
                      <ul className="mydel-list01">
                          <li>탈퇴하신 아이디는 복구가 불가능하며, 추후 동일한 아이디로 재가입이 되지 않습니다.</li>
                          <li>에듀블록 모든 사이트에서도 동시 탈퇴됩니다.</li>
                          <li>학습 이력 정보는 모두 삭제되며, 삭제된 데이터는 복구되지 않습니다.</li>
                      </ul>
