    ...
    return (
        <main className={clsx(content, {
            ...
            <Switch>
                ...
                <Route  path='/block_manager_servers' component={BlockManagerPageServers} />
                <Route  path='/block_manager_org' component={BlockManagerPageOrg} />
                <Route  path='/block_manager_ordered' component={BlockManagerPageOrdered} />
                <Route  path='/block_manager_peer' component={BlockManagerPagePeer} />
                <Route  path='/block_manager_channel' component={BlockManagerPageChannel} />
                <Route  path='/block_manager_chaincodes' component={BlockManagerPageChaincodes} />
                <Route  path='/block_manager_caservers' component={BlockManagerPageCAServers} />
                <Route  path='/block_manager_causers' component={BlockManagerPageCAUsers} />
                <Route  path='/block_history_blocks' component={BlockHistoryPageBlocks} />
                <Route  path='/block_history_transactions' component={BlockHistoryPageTransactions} />
                ...
                <Route  path='/setting_administrator' component={SettingPageAdministator} />
