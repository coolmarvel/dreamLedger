            ...
            return (
                ...
                <div className="manage-srch-cont">
                    <dl className="dl-srch dl01">
                        <dt>가입일자</dt>
                        <dd><input type="text" name="regDateStart" className="sitxt01"  onChange= {onChange}/> ~ <input type="text" name="regDateEnd"  onChange= {onChange} className="sitxt01" /></dd>
                    </dl>
                    <dl className="dl-srch dl02">
                        <dt>ID</dt>
                        <dd><input type="text" name="memberId" className="sitxt02" onChange= {onChange} /></dd>
                    </dl>
                    <dl className="dl-srch dl03">
                        <dt>이름</dt>
                        <dd><input type="text" name="member_student_name" className="sitxt02" onChange= {onChange} /></dd>
                    </dl>
                    <dl className="dl-srch dl04">
                        <dt>성별</dt>
                        <dd><select name="member_student_sex"   className="srselct01" onChange= {onChange} >
                    ...
                    <dl className="dl-srch dl05">
                        <dt>생년월일</dt>
                        <dd><input type="text" name="birthdayStart" className="sitxt01" onChange= {onChange} /> ~ <input type="text" name="birthdayEnd" className="sitxt01" onChange= {onChange} /></dd>
                    </dl>
                    <dl className="dl-srch dl06">
                        <dt>학교</dt>
                        <dd><select name="edulevel_schoolType"   className="srselct02" onChange= {onChange} >
                            <option value="">선택</option>
                            <option value="MIDDLE_SCHOOL">중학교</option>
                            <option value="HIGH_SCHOOL">고등학교</option>
                            <option value="COLLEGE">대학교</option>
                        </select>
                            <input type="text" name="edulevel_schoolName" className="sitxt03" onChange= {onChange} />
                            <button type="button"  className="btn-srch" onClick={onSearch}>조회</button>
                        </dd>
                    </dl>
                </div>
