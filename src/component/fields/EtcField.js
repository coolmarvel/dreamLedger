            ...
            <div className="edit-cont-wrap">
                <div className="edit-cont">
                    ...
                    <form className={classes.root} noValidate autoComplete="off"  >
                        <FormControl variant="outlined"  className="{classes.formControl} itxt-wrap01 cell03-02">
                            <InputLabel required  id="schoolType">활동구분</InputLabel>
                            <Select
                                name="typeCode"
                                labelId="typeCode"
                        ...
                        <TextField           className="itxt-wrap01 cell03-02" name="name" label="Outlined" variant="outlined" label={"활동명"}    value={info.name} onChange={onUpdateField}/>
                        <TextField required  className="itxt-wrap01 cell03-03" name="startMonth"
                                   placeholder={'yyyy-mm'} InputProps={{classes: { input: classes.input}}}
                                   label="Outlined" variant="outlined" label={"시작년월"} value={info.startMonth} onChange={onUpdateField}/>
                        <TextField required  className="itxt-wrap01 cell03-04" name="endMonth"
                                   placeholder={'yyyy-mm'} InputProps={{classes: { input: classes.input}}}
                                   label="Outlined" variant="outlined" label={"종료년월"} value={info.endMonth} onChange={onUpdateField}/>
                        <br />
                    ...
                    <div className="info-cont">
                        <div className="info-cont-inner">
                            ...
                            <div className="cont-inner-right">
                                <div className="right-tit-wrap"><span className="right-tit">활동명: {info.name}</span><span
