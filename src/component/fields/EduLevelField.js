...
const  EduLevelField = (props) => {
    ...
    const onUpdateField = (e) => {
        ...
        if(e.target.name ==='admissionYear' ||e.target.name ==='graduationYear'){
                ...
                <div className="edit-cont-wrap" >
                    <div className="edit-cont">
                        ...
                        <form className={classes.root} noValidate autoComplete="off" >
                            <FormControl variant="outlined"  className="{classes.formControl} itxt-wrap01 cell02-01 exist-val" >
                                <InputLabel required  id="schoolType" >학교구분</InputLabel>
                                <Select
                                    name="schoolType"
                                    labelId="schoolType"
                            ...
                            <TextField required  className="itxt-wrap01 cell02-02" name="schoolName" label="Outlined"  variant="outlined" label={"학교명"} value={info.schoolName} onChange={onUpdateField}/>
                            <TextField required  className="itxt-wrap01 cell02-03" name="admissionYear" label="Outlined"
                                       placeholder={'4자리숫자'} InputProps={{classes: { input: classes.input}}}
                                       variant="outlined" label={"입학년도"} value={info.admissionYear} onChange={onUpdateField}/>
                            <TextField required  className="itxt-wrap01 cell02-04" name="graduationYear"
                                       placeholder={'4자리숫자'} InputProps={{classes: { input: classes.input}}}
                                       label="Outlined" variant="outlined" label={"졸업년도"} value={info.graduationYear} onChange={onUpdateField}/>

                            <FormControl variant="outlined"  className="{classes.formControl} itxt-wrap01 cell02-02" >
                        ...
                        <div className="info-cont">
                            <div className="info-cont-inner">
                                <div className="cont-inner-left">
                                    <p className="left-date">{info.admissionYear} ~ {info.graduationYear}</p>
                                    <p className="left-state">{graduationStatus}</p>
                                </div>
                                <div className="cont-inner-right">
                                    <div className="right-tit-wrap"><span className="right-tit">{info.schoolName}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
